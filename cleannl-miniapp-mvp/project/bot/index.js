...
bot.launch().then(() => {
  ...
  // Een 409-conflict treedt vaak tijdelijk op tijdens het herstarten van de service
  // (de oude en nieuwe versie vragen heel even allebei tegelijk updates op bij Telegram).
  // We loggen het en laten de health-check server gewoon doordraaien i.p.v. het hele proces te laten crashen.
